...
partial class AppSettings : ISettingsRoot
{
  ...
  private PropertyBacker<string>? _themeBacker;
  public partial string Theme
  {
    get => _themeBacker?.Value ?? "light";
    set
    {
      if (_themeBacker!.TrySet(value))
      {
        OnPropertyChanged(new System.ComponentModel.PropertyChangedEventArgs(nameof(Theme)));
  ...
  {
    _themeBacker ??= new PropertyBacker<string>(keyPrefix, nameof(Theme), "light");
    _themeBacker.SetStore(store);
    if (_themeBacker.GetInitialValue("light"))
    {
      OnPropertyChanged(new System.ComponentModel.PropertyChangedEventArgs(nameof(Theme)));
      OnThemeChanged(_themeBacker.Value);
    }
  }
